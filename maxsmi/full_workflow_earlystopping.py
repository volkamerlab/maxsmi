...
from maxsmi.pytorch_utils.pytorch_training import model_training_earlystopping
...
if __name__ == "__main__":
    ...
    folder = (
        f"maxsmi/output_{args.folder_iteration}/{args.task}_{args.string_encoding}_"
        f"{args.augmentation_strategy_train.__name__}"
    ...
    if args.string_encoding == "smiles":
        ...
        # Note: Augmentation on the valid set is automatically the same as on the train
    ...
    logging.info("========")
    logging.info(f"Training for maximum {args.number_epochs} epochs or early stopping")
    logging.info("========")
